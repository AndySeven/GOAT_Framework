$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/resources/features/01_AddMemberships.feature");
formatter.feature({
...
formatter.uri("file:src/test/resources/features/02_AddMembershipToEmployee.feature");
formatter.feature({
...
formatter.embedding("image/png", "embedded3.png", "As Admin i wand to add memberships to any employee");
formatter.after({
  "status": "passed"
});
});